...
<!----------------------------------------CUSTOMER------------------------------->
<form action="deletebata.php" id="customer" method="post" style="display:none;">
...
<!---------------------------------------EMPLOYEE----------------------------------->
<form action="deletebata.php" id="employee" method="post" style="display:none;">
...
<!------------------------------------INVOICE------------------------------------------>
<form action="deletebata.php" id="invoice" method="post" style="display:none;">
...
<!------------------------------------OFFER----------------------------------------------->
<form action="deletebata.php" id="offer" method="post" style="display:none;">
...
<!----------------------------------PRODUCT----------------------------------------------->
<form action="deletebata.php" id="product" method="post" style="display:none;">
...
<form action="deletebata.php" id="retaildistributioncenter" method="post" style="display:none;">
...
<!-----------------------------SHOWROOM--------------------------------------------------->
<form action="deletebata.php" id="showroom" method="post" style="display:none;">
...
<!-------------------------------------STOCK------------------------------------------------>
<form action="deletebata.php" id="stock" method="post" style="display:none;">
...
<!---------------------------------STOCK_DESCRIPTION------------------------------------------->
<form action="deletebata.php" id=stock_description" method="post" style="display:none;">
